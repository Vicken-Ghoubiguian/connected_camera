...
std::string usefull_functions::print_howto_in_window()
{
	...
	print_howto_string = print_howto_string + "* Colormap winter mode - press 'b' \n";
	print_howto_string = print_howto_string + "* Colormap rainbow mode - press 'j' \n";
	print_howto_string = print_howto_string + "* Colormap hot mode - press 'v' \n";
	print_howto_string = print_howto_string + "* Colormap parula mode - press 'x' \n";
	print_howto_string = print_howto_string + "* Colormap spring mode - press 'z' \n";
	print_howto_string = print_howto_string + "* Colormap ocean mode - press 'q' \n";
	print_howto_string = print_howto_string + "* Colormap jet mode - press 'k' \n";
	print_howto_string = print_howto_string + "* Colormap HSV mode - press '_' \n";
	print_howto_string = print_howto_string + "* Colormap bone mode - press '+' \n";
	print_howto_string = print_howto_string + "* Colormap autumn mode - press '-' \n";
	print_howto_string = print_howto_string + "* Colormap summer mode - press '*' \n";
	print_howto_string = print_howto_string + "* Colormap cool mode - press '.' \n";
	print_howto_string = print_howto_string + "* Colormap pink mode - press '\' \n";
...
void usefull_functions::print_howto_in_konsole()
{
	...
	cout << terminal_color_codes::Yellow + "* Colormap winter effect mode - press 'b' \n" + terminal_color_codes::ResetAll;
	...
	cout << terminal_color_codes::Yellow + "* Colormap HSV mode - press '_' \n" + terminal_color_codes::ResetAll;
