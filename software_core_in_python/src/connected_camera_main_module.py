...
def exploits_function(output_video_name, output_video_format, output_photo_name, output_photo_format):
	...
	while True:
		...
		if is_current_mode == 'p':
			...
			frame = frame_mode_module.black_and_white_frame_converting_function(frame, cv2.COLOR_BGR2GRAY)
		...
		if c == 27:
			...
			if is_shoting_video == True:
				...
				usefull_functions_module.merging_audio_file_and_video_file_function(
					'../repository_common_files/output_media_files/videos/temporary_directory/output_video_file' + output_video_format,
					'../repository_common_files/output_media_files/videos/temporary_directory/output_audio_file.wav',
